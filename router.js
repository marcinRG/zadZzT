...
const router = (elementID) => {
    // Lazy load view element:
    el = el || document.getElementById(elementID);
...
window.addEventListener('hashchange', () => router('app-modified'));
window.addEventListener('load', () => router('app-modified'));